...
while IFS=',' read -r CLUSTER_ID CLUSTER_NAME || [[ -n "$CLUSTER_ID" ]]; do
    ...
    RESPONSE=$(curl --silent --location \
        --request GET \
        --url "https://api.cast.ai/v1/cost-reports/clusters/$CLUSTER_ID/efficiency?startTime=2026-03-15T00%3A00%3A00.000000Z&endTime=2026-03-17T00%3A00%3A00.000000Z" \
